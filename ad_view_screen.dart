              ...
              data['image'].length != 0
                  ? Stack(
                      children: [
                        ...
                        //         //         height: Get.height * 0.90,
                        //         //         width: Get.width * 0.20,
                        //         //         child: Image.network(ImagesAdds[10],
                        //         //             height: Get.height * 0.20,
                        //         //             fit: BoxFit.fill)),
                        //         //     SizedBox(width: Get.width * 0.01),
                        //         //     Container(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Padding(
                              padding: Get.height < 700
                                  ? EdgeInsets.only(top: 2.0, bottom: 2.0)
                                  : EdgeInsets.all(0),
                              child: GestureDetector(
                                onTap: () {
                                  Get.to(FriendProfile(), arguments: [
                                    "ads",
                                    data['created_by']['id']
                                  ]);
                                },
        ...
        ? Column(
            ...
            children: [
              Padding(
                ...
                child: data.length == 1
                    ? Text("There are " + data.length.toString() + " comment",
                        style: TextStyle(
                            fontSize: 16,
                            fontWeight: FontWeight.bold,
                            color: Colors.grey))
                    : Text("There are " + data.length.toString() + " comments",
                        style: TextStyle(
                            fontSize: 16,
                            fontWeight: FontWeight.bold,
                            color: Colors.grey)),
                                                  ...
                                                  child: ClipRRect(
                                                      borderRadius:
                                                          BorderRadius.circular(
                                                              50.0),
                                                      child: data[index]['user_name'] !=
                                                                  null &&
                                                              data[index]['user_name']['image'] !=
                                                                  null
                                                          ? CircleAvatar(
