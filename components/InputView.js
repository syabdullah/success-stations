...
const InputView = ({ changeTextEvent , imageSource, placeholderText, isSecureField, isFullWidth, keyboardTypeValue = "default" ,value = '',isEnable = true}) => {
