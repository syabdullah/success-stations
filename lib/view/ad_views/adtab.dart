              ...
              return val.isLoading == true
                  ...
                  : val.userAds != null && val.userAds['data'] != null
                      ...
                      : Padding(
                        ...
                        child: Container(child: Center(child: Text("No Ads Yet",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18),))),
        ...
        itemBuilder: (BuildContext context, index) {
          ...
          return GestureDetector(
            ...
            child: GestureDetector(
              onTap: ()=> Get.to(AdViewScreen(), arguments: allDataAdds[index]['id']),//Get.toNamed('/adPostingScreen'),
              child: Card(
                child: Container(
                  height: 100,
                  child: Row(
