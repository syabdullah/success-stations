          ...
          children: [
            ...
            GetBuilder<UserOfferController>( 
              ...
              builder: (value){ 
                ...
                lastAds2(value.offerDattaTypeCategory['data']):Center(child: CircularProgressIndicator());
              }
            ),
            Container(
              margin: lang=='en'? EdgeInsets.only(left:08):EdgeInsets.only(right:08),
      ...
      children: [
        ...
        Card(
          child: Column(
            children: [
              Container(
                padding: EdgeInsets.only(right:Get.height/5.7, left:20,  top:10),
                child: Row(
              ...
              Container(
                padding: EdgeInsets.only(right:Get.height*0.02,left:20,),
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children:[
                    userData2['name'] !=null ?
                    ...
                    Column(
                      children: [
                        ...
                        Container(
                          padding: EdgeInsets.only(right:Get.height*0.04,left:20,),
                          child: GestureDetector(
                            ...
                            child: Text(
                              userData2['email'].length > 20 ? userData2['email'].substring(0, 20)+'...' : userData2['email'],
              ...
              Container(
                padding: EdgeInsets.only(right: Get.height/6, left:20,top:10),
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text(
                        ...
                        Container(
                          child: GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: Text(
                                userData2['address'].length > 20 ? userData2['address'].substring(0, 20)+'...' : userData2['address'],
                                style: TextStyle(fontWeight: FontWeight.w600)
                              ),
                            ),
                          ),
   ...
   return Container(
    ...
    child: ListView.builder(
      ...
      itemBuilder: (BuildContext context,index) {
        print("values of the data ...${offerDattaTypeCategory[index]['image']['url']}");
        return Column(
          children: [
            Card(
              elevation: 3,
