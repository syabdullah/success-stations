...
//         builder: (val) {
//           return val.offerDattaTypeCategory['data'] && val.offerDattaTypeCategory['data'] !=null ? headingUpsell(val.offerDattaTypeCategory['data']):
//           Container();
//         },
//       ),
//       //headingUpsell(),
...
class _OfferListState extends State<OfferList> {
  ...
  var id;
  var grid = AppImages.gridOf;
  Color offerCategoryselectedColor = Colors.blue;
  var bottomSheetCategory =0;
  Color filterCategoryColor = Colors.blue;
  Color listIconColor = Colors.grey;
  var offerListCategory = 0;
  var status;
  var category;
  var start;
  var end;
    ...
    return Scaffold(
      body: Column(
        ...
        GetBuilder<OfferCategoryController>(
          init: OfferCategoryController(),
          builder: (val) {
            return val.offerDattaTypeCategory !=null && val.offerDattaTypeCategory['data']!=null ?   
            headingCategory(val.offerDattaTypeCategory['data']): Container();
          },
        ),
        GetBuilder<OffersFilteringController>(
          init: OffersFilteringController(),
  ...
  Widget headingCategory(dataListedCateOffer) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Container(
                ...
                children: [
                  Container(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        setState(() {
                          offerListCategory = cate;
                          id = dataListedCateOffer[cate]['id'];
                        });
                      },
                      child: Container(
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(20.0),
                          border: Border.all(color: Colors.blue),
                          color: offerListCategory == cate? offerCategoryselectedColor : Colors.white,
                          boxShadow: [
                            BoxShadow(
                              color: Colors.grey,
                              offset: Offset(0.0, 1.0),
                        ...
                        padding: EdgeInsets.all(10.0),
                        child: Text(
                          dataListedCateOffer[cate]['category_name']['en'],
                          style: TextStyle(
                            color: offerListCategory == cate ? Colors.white : Colors.blue,
                            fontSize: 12,
                            fontStyle: FontStyle.normal,
                          ),
                        ),
