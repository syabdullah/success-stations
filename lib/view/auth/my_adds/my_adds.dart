...
class _MyAddsState extends State<MyAdds> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //   child: myAdds(_scaffoldKey, context, AppImages.appBarLogo,
            ...
            return ListView(
              children: [
                ...
                GetBuilder<CategoryController>(
                  ...
                  builder: (data) {
                    return data.myHavingAdds != null &&
                            data.myHavingAdds['data'] != null
                ...
                categorybool == false
                    ? GetBuilder<AddBasedController>(
                        ...
                        builder: (val) {
                          return val.myALLAdd != null &&
                                  val.myALLAdd['data'] != null &&
  ...
  Widget myAddsList(dataListValue) {
    return ListView.builder(
      shrinkWrap: true,
      physics: NeverScrollableScrollPhysics(),
      itemCount: dataListValue.length,
          ...
          children: List.generate(dataListValue.length, (index) {
            ...
            return ColorFiltered(
              ...
              child: Container(
                  ...
                  height:
                      Get.height < 420 ? Get.height / 3.6 : Get.height / 8.0,
                  child: GestureDetector(
                    onTap: () {
                      Get.to(AdViewScreen(),
                          arguments: dataListValue[index]['id']);
                    },
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        ...
                        child: GestureDetector(
                          onTap: () {
                            setState(() {
                              ...
                              textAllcheck = true;
                              controller.addedByIdAddes(
                                  listingCategoriesData[index]['id'], userId);
                            });
                          },
                          child: Container(
                              decoration: BoxDecoration(
