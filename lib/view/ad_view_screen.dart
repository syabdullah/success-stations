            ...
            return val.adsD != null && val.adsD['data'] != null
                ? SafeArea(
                    child: Row(
                      ...
                      children: [
                        previousButton(
                            AppImages.heart, "favC".tr, Colors.grey, ''),
                        previousButton(AppImages.contact, 'contactC'.tr,
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          Padding(
                            ...
                            child: Text("""There are many variations of passages of LoremIpsum available, but the majority have suffered alteration in some form, by injected humour,randomised words which don't look eve……..
                """),
                          )
                        ]),
                      ),
                  ...
                  Row(
                    children: [
                      CircleAvatar(
                          ...
                          child: ClipRRect(
                              borderRadius: BorderRadius.circular(50.0),
                              child: data[index]['user_name'] != null &&
                                      data[index]['user_name']['image'] != null
                                  ? CircleAvatar(
                                      backgroundColor: Colors.grey[200],
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                                width: Get.width / 3,
                                child: data[index]['user_name'] != null &&
                                        data[index]['user_name']['name'] != null
                                    ? Text(
  ...
  Widget commentButton() {
    return Container(
      ...
      child: ElevatedButton(
        ...
        child: Container(child: Text('add_a_comment'.tr)),
      ),
    );
  }
