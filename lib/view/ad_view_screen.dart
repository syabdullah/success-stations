    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: GetBuilder<MyAddsController>(
            ...
            builder: (val) {
              print("....here....the value......${val.adsD}");
              return val.isLoading == true || val.adsD == null
                  ? Center(child: CircularProgressIndicator())
                  : val.adsD == null
                      ? Container(
                          child: Center(
                            child: Text("NO Detail Here !"),
                          ),
                        )
                      : Column(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Text(
                                val.adsD != null
                                    ? "${val.adsD['data']['listing_comments'].length} People Commented on this ad."
                                    : '',
                                style: AppTextStyles.appTextStyle(
                                  fontSize: 14.h,
                                  fontWeight: FontWeight.bold,
                            ...
                            Row(
                              ...
                              children: [
                                previousButton(AppImages.heart, AppString.fav,
                                    Colors.grey, ''),
                                previousButton(
                                    AppImages.contact,
                                    AppString.contact,
    ...
    return data == null
        ...
        : ListTile(
            ...
            trailing: GestureDetector(
              onTap: () {
                // print("....hjhjhjhj..//'''''${dataa[index]['id']}..");
                var selected = box.write("selected", data['contact_name']);
                // var requisterId =
                //     box.write("requister", data['id']['requister_id']);

                print("....here...the ...selected...${box.read("selected")}");
                print(
                    "....!!!!!!...here the value of user of deleted one....${data['id']}");
                Get.to(UserProfile(),
                      arguments: data['id'] != data['created_at']);
                      // dataa[index]['requister_id']
                      //     ? dataa[index]['requister_id']
                      //     : dataa[index]['user_requisted']['id']););
                // arguments: id != data['requister_id']
                //     ? data['requister_id']
                //     : data['user_requisted']['id']);
              },
              child: Text(
                "${"see_profile".tr} >",
                style: AppTextStyles.appTextStyle(
                      ...
                      CircleAvatar(
                          ...
                          child: ClipRRect(
                              ...
                              child: data[index]['media'] != null
                                  ? Image.network(data[index]['media']['url'])
                                  : Image.asset(AppImages.person))),
                      Padding(
                        padding: const EdgeInsets.only(left: 8.0),
                        child: Column(
  ...
  Widget mytraling(idU) {
    return Column(
      children: [
        GestureDetector(
          onTap: () {
            var json = {'user_reported': idU['user_name']['id']};
