...
Widget appbar(GlobalKey<ScaffoldState> globalKey, context, image, searchImage,
  ...
  return lang == 'en' || lang == null ? AppBar(
    ...
    leading: index == 2 ? Container(
      ...
      child: IconButton(
          iconSize: 40,
          icon: Image.asset(
              AppImages.menuBurger, height: 15, color: AppColors.grey),
  ...
  AppBar(
    ...
    Container(
      ...
      child: IconButton(
        icon: Image.asset(
            AppImages.filterImage, color: Colors.grey, height: 35),
        onPressed: () =>
        index == 4 ? filteringCategory(context) :
        Get.bottomSheet(FriendFilter()),
      ),
          ...
          children: [
            GestureDetector(
                ...
                child: Container(
                  ...
                  index == 0 ? Image.asset(AppImages.map1, height: 20) : Image
                      .asset(AppImages.listingImage, height: 20),
                )
            ),
            GestureDetector(
              onTap: () {
...
Widget favAdds(GlobalKey<ScaffoldState> globalKey, context, image, searchImage,
    index) {
  return lang == 'en' || lang == null ? AppBar(
    automaticallyImplyLeading: false,
    centerTitle: true,
  ...
  AppBar(
    ...
    actions: [
      Container(
        margin: lang == 'en' ? EdgeInsets.only(right: 20, top: 14) : EdgeInsets
            .only(left: 10, top: 14),
        child: Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            ...
            GestureDetector(
              ...
              child: Container(
                  margin: lang == 'ar' ? EdgeInsets.only(right: 10) : EdgeInsets
                      .only(left: 8),
...
Widget myAdds(GlobalKey<ScaffoldState> globalKey, context, image, searchImage,
    index) {
  return AppBar(
    automaticallyImplyLeading: false,
    centerTitle: true,
            ...
            children: [
              ...
              GestureDetector(
                ...
                child: Container(
                    ...
                    child: Image.asset(
                        AppImages.plusImage, color: Colors.grey, height: 22)
                ),
              ),
            ],
          ),
                                ...
                                Container(
                                  ...
                                  child: Text(
                                      "${_currentRangeValues.start.round()
                                          .toString()} miles", style: TextStyle(
                                      fontSize: 15,
                                      color: Colors.black,
                                          ...
                                          onPressed: () {
                                            ...
                                            if (decideRouter == 'city' ||
                                              ...
                                              if (cityArray.length != 0) {
                                                var cityFinal = cityArray
                                                    .toString();
                                                cityFinalData =
                                                    cityFinal.substring(1,
                                                        cityFinal.length - 1);
                                              } else {
                                                cityFinalData = null;
                                              }
                              ...
                              builder: (data) {
                                return data.allOffersResp != null &&
                                  ...
                                  child: ListView.builder(
                                      ...
                                      itemCount: data.allOffersResp['data']
                                          .length,
                                            ...
                                            Container(
                                              ...
                                              child: GestureDetector(
                                                ...
                                                child: Container(
                                                    ...
                                                    child: Text(
                                                      data
                                                          .allOffersResp['data'][index]['category_name'][lang] !=
                                                          null ? data
                                                          .allOffersResp['data'][index]['category_name'][lang]
                                                          .toString() :
                                                      data
                                                          .allOffersResp['data'][index]['category_name'][lang] ==
                                                          null ? data
                                                          .allOffersResp['data'][index]['category_name']['en']
                                                          .toString() : '',
                                                      style: TextStyle(
                                                        color: bottomSheetCategory ==
                                                            index
                              ...
                              builder: (data) {
                                return data.isLoading == true
                                  ...
                                  child: ListView.builder(
                                      shrinkWrap: true,
                                      scrollDirection: Axis.horizontal,
                                      itemCount: data.havingAddsList['data']
                                          .length,
                                      itemBuilder: (BuildContext ctxt,
                                          int index) {
                                        return Row(
                                            ...
                                            Container(
                                              ...
                                              child: GestureDetector(
                                                ...
                                                child: Container(
                                                    ...
                                                    child:
                                                    Text(data
                                                        .havingAddsList['data'][index]['category'][lang] !=
                                                        null ? data
                                                        .havingAddsList['data'][index]['category'][lang]
                                                        .toString() :
                                                    data
                                                        .havingAddsList['data'][index]['category'][lang] ==
                                                        null ? data
                                                        .havingAddsList['data'][index]['category']['en']
                                                        .toString() : '',
                                                      style: TextStyle(
                                                        color: filteredIndex ==
                                                            index
