class AppImages {
  ...
  static String profileBack = imagePath + "back_arrow.png";
  static String profileEdit = imagePath + "edit_profile.png";
  ...
  static String contactus = imagePath + 'contactus.png';
  static String fav = imagePath + 'f.png';
  static String freq = imagePath + 'freq.png';
  ...
  static String topImage1 = imagePath + 'unnamed.jpg';
  ...
  static String setting = imagePath + '21.png';
  static String imagearrow1 = imagePath + 'imagearrow.png';
  static String send = imagePath + 'send.png';
